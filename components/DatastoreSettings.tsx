    ...
    <form onSubmit={methods.handleSubmit(handleUpdatePlugin)}>
      <Stack gap={2}>
        ...
        <FormControl>
          ...
          <Input
            control={methods.control as any}
            placeholder="e.g. Griot is a no-code platform for building AI apps..."
      ...
      <FormControl sx={{ gap: 1 }}>
        <Stack spacing={2}>
          ...
          <Alert
            ...
            endDecorator={
              <Link href="https://docs.mongriot.com" target="_blank">
                <Button
                  variant="plain"
                  size="sm"
                  endDecorator={<ArrowForwardRoundedIcon />}
        ...
        {getDatastoreQuery?.data?.id && (
          <FormControl sx={{ gap: 1 }}>
            ...
            <Alert
              ...
              endDecorator={
                <Link
                  href="https://docs.mongriot.com/integrations/chatgpt-plugin"
                  target="_blank"
                >
                  <Button
                    variant="plain"
