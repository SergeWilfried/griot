...
<link rel="stylesheet" href="<?php echo plugins_url("assets/style.css", __FILE__ );?>">
  ...
  <div class="wrap chaindesk-wrap">
    <div class="chaindesk-modal">
      <h2 class="chaindesk-title"><?php _e('Connected with Griot.', 'chaindesk'); ?></h2>
      <p class="chaindesk-subtitle"><?php _e('You can now use Griot from your homepage.', 'chaindesk'); ?></p>
      <!-- <a class="chaindesk-button chaindesk-neutral" href="https://app.crisp.chat/settings/website/<?php echo $agent_id ?>"><?php _e('Go to my Griot Settings', 'chaindesk'); ?></a> -->
    ...
    <!-- <p class="chaindesk-notice"><?php _e('Loving Griot <b style="color:red">♥</b> ? Rate us on the <a target="_blank" href="https://wordpress.org/support/plugin/chaindesk/reviews/?filter=5">Wordpress Plugin Directory</a>', 'chaindesk'); ?></p> -->
  </div>
  ...
  <div class="wrap chaindesk-wrap">
    <div class="chaindesk-modal">
      <h2 class="chaindesk-title"><?php _e('Connect with GriotAI', 'chaindesk'); ?></h2>
      <p class="chaindesk-subtitle"><?php _e('This link will redirect you to Griot and configure your Wordpress.', 'chaindesk'); ?></p>
      <a class="chaindesk-button chaindesk" href="<?php echo $add_to_chaindesk_link; ?>"><?php _e('Connect with Griot', 'chaindesk'); ?></a>
    </div>
  </div>
  <?php
  }
